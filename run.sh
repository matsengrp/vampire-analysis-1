...
tcr-vae pvae output/basic_params.json output/all-subjects.train.200K.best_weights.h5 output/all-subjects.train.10K.csv output/all-subjects.train.10K.pvae.csv
